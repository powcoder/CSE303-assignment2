...
cse303.do_cmd("Setting key k1.", "OK", client.kvI(alice, "k1", afile1), server)
...
cse303.do_cmd("Upserting key k1.", "OKUPD", client.kvU(alice, "k1", afile2), server)
cse303.do_cmd("Getting key k1.", "OK", client.kvG(alice, "k1"), server)
...
cse303.line()
cse303.do_cmd("Upserting key k2.", "OKINS", client.kvU(alice, "k2", afile1), server)
cse303.do_cmd("Getting key k2.", "OK", client.kvG(alice, "k2"), server)
cse303.check_file_result(afile1, "k2")
cse303.do_cmd("Upserting key k2.", "OKUPD", client.kvU(alice, "k2", afile2), server)
cse303.do_cmd("Getting key k2.", "OK", client.kvG(alice, "k2"), server)
...
cse303.line()
cse303.do_cmd("Getting all keys to make sure it's k1 and k2.", "OK", client.kvA(alice, allfile), server)
...
cse303.line()
cse303.do_cmd("Deleting key k2.", "OK", client.kvD(alice, "k2"), server)
...
cse303.line()
cse303.do_cmd("Inserting key k3.", "OK", client.kvI(alice, "k3", afile1), server)
...
cse303.check_file_result(afile2, "k1")
cse303.do_cmd("Getting key k2.", "ERR_KEY", client.kvG(alice, "k2"), server)
cse303.do_cmd("Getting key k3.", "OK", client.kvG(alice, "k3"), server)
